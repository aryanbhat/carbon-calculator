$(document).ready(function() {
	...
	$("#calculate-btn").on("click", function() {
		var calculateAndDisplayScore = function() {
			...
			var wasteInput = document.getElementById("waste").value;
			var carInput = document.getElementById("car").value;
			var flights4LessInput = document.getElementById("goodstransported-4-less").value;
			...
			if (wasteInput === 0 || wasteInput === "undefined") {
				oilScore = 0;
			} else {
				oilScore = wasteInput * 113;
			}
